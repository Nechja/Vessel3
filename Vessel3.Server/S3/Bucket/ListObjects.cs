...
internal sealed class ListObjects(IBucketLister lister, IS3XmlWriter xml, IHttpResultMapper http) : IS3Action
{
    public S3Route Route => new(HttpMethods.Get, S3Subresource.None);
