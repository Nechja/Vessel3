...
mkdir -p "$WORK/out/aws-sync" && chmod 777 "$WORK/out/aws-sync"
...
mkdir -p "$WORK/out/mc-mirror" && chmod 777 "$WORK/out/mc-mirror"
...
mkdir -p "$WORK/out/rclone" && chmod 777 "$WORK/out/rclone"
...
mkdir -p "$WORK/out/rclone-sync" && chmod 777 "$WORK/out/rclone-sync"
